...
class SignApp extends Command {
     ...
     * @param IURLGenerator
     */
    public function __construct(Checker $checker, FileAccessHelper $fileAccessHelper, IURLGenerator $urlGenerator) {
    ...
    protected function configure() {
        $this
            ...
            ->setDescription('sign an app using a private key')
